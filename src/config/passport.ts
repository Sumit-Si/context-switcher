...
import { generateUniqueUsername, isMongoUniqueViolation } from "../utils/usernameUtils";
...
passport.use(new GoogleStrategy({
    ...
    try {
        ...
        if (existingUserByEmail) {
            ...
            if (existingUserByEmail.authProvider === "local" || existingUserByEmail.authProvider === "google"
            ) {
