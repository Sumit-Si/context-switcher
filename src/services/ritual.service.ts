...
export interface IRitualService {
    getAll(userId: string, options: PaginationOptions): Promise<PaginatedResult<RitualSchemaProps>>;
    ...
    update(id: string, data: UpdateRitualDTO, userId: string): Promise<RitualSchemaProps>;
    delete(id: string, userId: string): Promise<void>;
}

export class RitualService extends BaseService<RitualSchemaProps> implements IRitualService {
    constructor() {
        super(Ritual);
    }
     ...
     */
    async create(data: CreateRitualDTO, userId: string): Promise<RitualSchemaProps> {
    ...
    async update(
        ...
        const updatedRitual = await this.model.findOneAndUpdate(
