...
import { createSwitchLogPostValidator, updateSwitchLogPatchValidator } from '../../src/validators';
    ...
    describe('createSwitchLogPostValidator', () => {
        describe('toContext validation', () => {
            ...
            it('should reject empty toContext', () => {
                ...
                if (!result.success) {
                    expect(result.error.issues[0].message).toContain('To context is required');
                }
            });
            ...
            it('should reject invalid toContext ObjectId', () => {
                ...
                expect(result.success).toBe(false);
                if (!result.success) {
                    expect(result.error.issues[0].message).toContain('Invalid toContext id');
                }
            });
        ...
        describe('fromContext validation', () => {
            ...
            it('should reject invalid fromContext ObjectId', () => {
                ...
                expect(result.success).toBe(false);
                if (!result.success) {
                    expect(result.error.issues[0].message).toContain('Invalid fromContext id');
                }
            });
        });
